...
export const BULLS: Bull[] = [
  ...
  },
  {
    ...
    description: "HUDSON is a balanced sire combining strong milk yield (+791) with excellent udder composite (+1.37) and strength. Daughters show durability, functional udders, and improved herd efficiency.",
    stats: {
      gtpi: 3167,
      milk: 791,
      udc: 1.37,
  ...
  },
  {
    ...
    description: "HARREL P-RED is a unique Polled Red sire with extreme type (+2.82) and high Udder Composite (+1.77). He brings excellent fertility (DPR +1.1) and is ideal for breeders looking for Red & Polled genetics without compromising on form.",
    stats: {
      gtpi: 2878,
      milk: 184,
      udc: 1.77,
  ...
  },
  {
    ...
    description: "QUALITY is a milk machine (+1717 lbs) with elite components. He combines this production with solid udder traits (+1.15 UDC) and positive fertility. A top choice for commercial herds focused on profitability.",
    stats: {
      gtpi: 3134,
      milk: 1717,
      udc: 1.15,
  ...
  },
  {
    ...
    description: "PRADA delivers exceptional components (+61 Fat, +36 Protein) and fertility (DPR +1.4). With a balanced Type profile (+1.22 PTAT) and strong udders, he is an excellent all-rounder for modern dairies.",
    stats: {
      gtpi: 3108,
      milk: 409,
      udc: 0.97,
  ...
  },
  {
    ...
    description: "HAVE IT ALL lives up to his name as a Daughter Proven Type Specialist. With +2.29 PTAT and +1.55 UDC, he produces show-winning daughters with strength and style. He is a King Doc grandson delivering elite confirmation.",
    stats: {
      gtpi: 2733,
      milk: -125,
      udc: 1.55,
  ...
  },
  {
    ...
    description: "HUNTER is a massive production sire (+1597 Milk) with balanced type (+1.54 PTAT). His positive component percentages and strong feet & legs (+1.12 FLC) make him an excellent choice for modern dairy systems.",
    stats: {
      gtpi: 3056,
      milk: 1597,
      udc: 0.59,
  ...
  },
  {
    ...
    description: "BLACKJACK P offers Polled genetics with strong production numbers (+520 Milk) and high Net Merit ($447). He is a solid improver for udder health and type (+1.59 PTAT), making him a versatile sire.",
    stats: {
      gtpi: 3151,
      milk: 520,
      udc: 1.36,
  ...
  },
  {
    ...
    description: "HAPPEN is an elite Type Specialist (+2.60 PTAT) known for producing show-winning daughters like 'Venturo Happen Rosani'. He offers exceptional frames and udders (+1.72 UDC) with A2A2 genetics.",
    stats: {
      gtpi: 2626,
      milk: 172,
      udc: 1.72,
